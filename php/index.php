...
<main class="page">
  <section class="hero">
    ...
    <div class="hero-inner">
      ...
      <div class="hero-actions">
        <a href="/php/services.php" class="btn-red">Pogledaj Usluge <i data-lucide="arrow-right"></i></a>
        <a href="/php/contact.php" class="btn-outline">Zakaži Termin</a>
      </div>
  ...
  <section class="section section-alt">
    <div class="section-inner">
      ...
      <div class="card-grid">
        <?php foreach (array_slice($services, 0, 3) as $service): ?>
          <div class="card">
            ...
            <a href="/php/services.php" class="link-red">
      ...
      <div class="center">
        <a href="/php/services.php" class="btn-red">Sve Usluge <i data-lucide="arrow-right"></i></a>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    ...
    <div class="section-inner center">
      ...
      <a href="/php/contact.php" class="btn-red glow-effect">Zakažite Termin <i data-lucide="arrow-right"></i></a>
    </div>
  </section>
</main>
